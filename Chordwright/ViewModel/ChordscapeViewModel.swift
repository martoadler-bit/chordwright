...
/// Bridges the UI to `ChordwrightAudioEngine`. Owns the tonal/generative controls
...
final class ChordwrightViewModel: ObservableObject {
    ...
    /// the scale, like Chordwright always did before this was added. Off hands
